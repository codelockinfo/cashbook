    ...
    modal.innerHTML = `
        ...
        <div id="customShareContent" style="position: fixed; bottom: 0; left: 0; width: 100%; background: #ffffff; border-radius: 20px 20px 0 0; z-index: 9999; transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1); overflow: hidden; box-shadow: 0 -10px 40px rgba(0,0,0,0.2); font-family: 'Inter', system-ui, sans-serif;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); padding: 25px 15px 35px 15px; background: #ffffff; gap: 20px 15px;">
                ...
                <!-- WhatsApp -->
                <a href="https://api.whatsapp.com/send?text=${encodedText}" target="_blank" onclick="closeCustomShareModal()" style="text-decoration: none; cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Telegram -->
                <a href="https://t.me/share/url?url=${encodedUrl}&text=${encodeURIComponent(originalMessage)}" target="_blank" onclick="closeCustomShareModal()" style="text-decoration: none; cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Messenger -->
                <a href="https://www.facebook.com/dialog/send?link=${encodedUrl}&app_id=291494419107518&redirect_uri=${encodedUrl}" target="_blank" onclick="closeCustomShareModal()" style="text-decoration: none; cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- MS Teams -->
                <a href="https://teams.microsoft.com/share?href=${encodedUrl}&msgText=${encodedText}" target="_blank" onclick="closeCustomShareModal()" style="text-decoration: none; cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
