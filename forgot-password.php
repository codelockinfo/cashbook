...
<head>
    ...
    <title>Forgot Password - Cash Book</title>
    <?php 
    require_once 'config.php';
    include 'pwa-meta.php'; 
    ?>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/auth-style2.css?v=<?php echo ASSET_VERSION; ?>">
</head>
<body>
    ...
    <script src="<?php echo BASE_PATH; ?>/pwa8.js?v=<?php echo ASSET_VERSION; ?>"></script>
