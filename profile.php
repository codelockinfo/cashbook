...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/style8.css?v=<?php echo defined('ASSET_VERSION') ? ASSET_VERSION : '1.0'; ?>">
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/auth-style6.css?v=<?php echo defined('ASSET_VERSION') ? ASSET_VERSION : '1.0'; ?>">
</head>
<body>
