    ...
    modal.innerHTML = `
        ...
        <div id="customShareContent" style="position: fixed; bottom: 0; left: 0; width: 100%; background: #ffffff; border-radius: 20px 20px 0 0; z-index: 9999; transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1); overflow: hidden; box-shadow: 0 -10px 40px rgba(0,0,0,0.2); font-family: 'Inter', system-ui, sans-serif;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); padding: 25px 15px 35px 15px; background: #ffffff; gap: 20px 15px;">
                ...
                <!-- WhatsApp -->
                <div onclick="openUniversalApp('whatsapp://send?text=${encodedText}', 'https://wa.me/?text=${encodedText}'); closeCustomShareModal()" style="cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Telegram -->
                <div onclick="openUniversalApp('tg://msg?text=${encodedText}', 'https://t.me/share/url?url=${encodedUrl}&text=${encodeURIComponent(originalMessage)}'); closeCustomShareModal()" style="cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Messenger -->
                <div onclick="openUniversalApp('fb-messenger://share/?link=${encodedUrl}', 'https://www.facebook.com/dialog/send?link=${encodedUrl}&app_id=291494419107518&redirect_uri=${encodedUrl}'); closeCustomShareModal()" style="cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- MS Teams -->
                <div onclick="openUniversalApp('msteams://teams.microsoft.com/l/message/0/0?text=${encodedText}', 'https://teams.microsoft.com/share?href=${encodedUrl}&msgText=${encodedText}'); closeCustomShareModal()" style="cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 8px;">
