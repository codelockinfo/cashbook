    ...
    modal.innerHTML = `
        ...
        <div id="customShareContent" style="position: fixed; bottom: 0; left: 0; width: 100%; background: #ffffff; border-radius: 20px 20px 0 0; z-index: 9999; transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1); overflow: hidden; box-shadow: 0 -10px 40px rgba(0,0,0,0.2); font-family: 'Inter', system-ui, sans-serif;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); padding: 25px 15px 35px 15px; background: #ffffff; gap: 20px 15px;">
                ...
                <!-- WhatsApp -->
                <a href="#" onclick="window.location.href='whatsapp://send?text=${encodedText}'; closeCustomShareModal(); return false;" style="text-decoration: none; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Telegram -->
                <a href="#" onclick="window.location.href='tg://msg?text=${encodedText}'; closeCustomShareModal(); return false;" style="text-decoration: none; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- Messenger -->
                <a href="#" onclick="window.location.href='fb-messenger://share/?link=${encodedUrl}'; closeCustomShareModal(); return false;" style="text-decoration: none; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                ...
                <!-- MS Teams -->
                <a href="#" onclick="window.location.href='msteams://teams.microsoft.com/l/message/0/0?text=${encodedText}'; closeCustomShareModal(); return false;" style="text-decoration: none; display: flex; flex-direction: column; align-items: center; gap: 8px;">
