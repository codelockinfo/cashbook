...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/auth-style6.css?v=<?php echo ASSET_VERSION; ?>">
</head>
<body>
    ...
    <script src="<?php echo BASE_PATH; ?>/auth6.js?v=<?php echo ASSET_VERSION; ?>"></script>
</body>
</html>
