...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/style18.css?v=<?php echo defined('ASSET_VERSION') ? ASSET_VERSION : '1.0'; ?>">
    <style>
        .groups-container {
            max-width: 1200px;
            margin: 0 auto;
...
<body>
    ...
    <script src="<?php echo BASE_PATH; ?>/groups17.js?v=<?php echo defined('ASSET_VERSION') ? ASSET_VERSION : '1.0'; ?>"></script>
</body>
</html>
